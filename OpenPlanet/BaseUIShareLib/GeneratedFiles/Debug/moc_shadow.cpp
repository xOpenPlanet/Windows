...
const QMetaObject Shadow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Shadow.data,
      qt_meta_data_Shadow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Shadow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Shadow.stringdata0))
        return static_cast<void*>(const_cast< Shadow*>(this));
