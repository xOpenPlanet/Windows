...
QT_MOC_LITERAL(1, 11, 14), // "sigUserProfile"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 18), // "sigClickedMenuItem"
QT_MOC_LITERAL(4, 46, 14) // "slotClickedBtn"

    },
    "MenuWidget\0sigUserProfile\0\0"
    "sigClickedMenuItem\0slotClickedBtn"
};
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigUserProfile(); break;
        case 1: _t->sigClickedMenuItem((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->slotClickedBtn(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWidget::sigUserProfile)) {
                *result = 0;
            }
        }
        {
            typedef void (MenuWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWidget::sigClickedMenuItem)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MenuWidget::sigUserProfile()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void MenuWidget::sigClickedMenuItem(QString _t1)
{
