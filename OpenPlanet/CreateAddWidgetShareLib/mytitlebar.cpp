...
void MyTitleBar::setTitleContentBKColor(QString strSheetStyle)
{
	m_pTitleContent->setStyleSheet(strSheetStyle);
}
...
// 设置标题内容;
void MyTitleBar::setTitleContent(QString titleContent, int titleFontSize,QString strFamily, bool bold )
{
	// 设置标题字体大小;
...
{
	QFile file(":/IMChatClient/Resources/" + sheetName + ".css");
...
void MyTitleBar::onButtonMaxClicked()
{
	...
	emit sigButtonMaxClicked();
}

void MyTitleBar::onButtonCloseClicked()
{
	emit sigButtonCloseClicked();
}
