...
QT_MOC_LITERAL(1, 15, 15), // "sigPasswordTrue"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 19) // "slotClickedEnterBtn"

    },
    "PasswordWidget\0sigPasswordTrue\0\0"
    "slotClickedEnterBtn"
};
...
void PasswordWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PasswordWidget *_t = static_cast<PasswordWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigPasswordTrue(); break;
        ...
        {
            typedef void (PasswordWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PasswordWidget::sigPasswordTrue)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PasswordWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PasswordWidget.data,
      qt_meta_data_PasswordWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void PasswordWidget::sigPasswordTrue()
{
