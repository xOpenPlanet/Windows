...
QT_MOC_LITERAL(1, 10, 12), // "sigGroupChat"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "type"
QT_MOC_LITERAL(4, 29, 10), // "strGroupID"
QT_MOC_LITERAL(5, 40, 10), // "sigProfile"
QT_MOC_LITERAL(6, 51, 10), // "strBuddyID"
QT_MOC_LITERAL(7, 62, 21), // "slotDoubleClickedItem"
QT_MOC_LITERAL(8, 84, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(9, 101, 4), // "item"
QT_MOC_LITERAL(10, 106, 13), // "doClickedItem"
QT_MOC_LITERAL(11, 120, 19), // "slotListContextMenu"
QT_MOC_LITERAL(12, 140, 5) // "point"

    },
    "GroupList\0sigGroupChat\0\0type\0strGroupID\0"
    "sigProfile\0strBuddyID\0slotDoubleClickedItem\0"
    "QListWidgetItem*\0item\0doClickedItem\0"
    "slotListContextMenu\0point"
};
...
void GroupList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slotDoubleClickedItem((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->doClickedItem((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 4: _t->slotListContextMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (GroupList::*_t)(int , QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupList::sigGroupChat)) {
                *result = 0;
            }
        }
        {
            typedef void (GroupList::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupList::sigProfile)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject GroupList::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_GroupList.data,
...
// SIGNAL 0
void GroupList::sigGroupChat(int _t1, QVariant _t2)
{
...
// SIGNAL 1
void GroupList::sigProfile(QString _t1)
{
